...
def main(argv: Optional[Sequence[str]] = None) -> int:
    ...
    if sum(1 for selected in selected_modes if selected) > 1:
        parser.error(
            "choose only one mode: --dry-run, --poll-once, --monitor, --heartbeat-once, --fake-smoke, --live-smoke, --console-tui, --console-gui, --ingest-user-memory, --lint-user-memory, or --check-config"
        )
    if not any(selected_modes):
        parser.error(
            "choose a mode: --dry-run, --poll-once, --monitor, --heartbeat-once, --fake-smoke, --live-smoke, --console-tui, --console-gui, --ingest-user-memory, --lint-user-memory, or --check-config"
        )
